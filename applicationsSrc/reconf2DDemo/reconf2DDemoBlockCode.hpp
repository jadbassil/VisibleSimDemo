...
static const int NOTIFY_MSG_ID = 1002;

using namespace Hexanodes;

class Reconf2DDemoBlockCode : public HexanodesBlockCode {
private:
    int distance;
    ...
    int maxDistance{0};
public :
    Reconf2DDemoBlockCode(HexanodesBlock *host);
    ~Reconf2DDemoBlockCode() {};
    ...
    void handleNotifyMessage(std::shared_ptr<Message> _msg, P2PNetworkInterface *sender);
...
/** needed to associate code to module                                      **/
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new Reconf2DDemoBlockCode((HexanodesBlock*)host));
    };
/*****************************************************************************/
};

#endif /* Reconf2DBlockCode_H_ */
